		...
		<div class="col-md-6 offset-md-3">
			<form>
				<div class="form-group"> 
					...
					<input class="form-control" type="text" v-model="food.name" :class=" {'is-invalid': $v.food.name.$error}" :disabled="showNewFood" ref="foodName">
					<ul class="list-group">
						<li 
				...
				<div class="row">
					<div class="col-md-6">
						<button class="btn btn-success" v-if="!showNewFood" @click="handleSubmit">Dodaj</button>
						<button class="btn btn-success" v-if="showNewFood" @click="returnToForm">Dodaj kolejny produkt</button>
					</div>
					<div class="col-md-6">
						<button class="btn btn-danger" @click="returnToDatabase">Wróc do bazy</button>
					</div>
				</div>
			</form>
		</div>
...
<style scoped> 
	...
	* {
	...
	/*ANIMATIONS*/
	    ...
	    .fade-leave-active {
	        animation: fade-out ease-out 0.1s;
	    }
